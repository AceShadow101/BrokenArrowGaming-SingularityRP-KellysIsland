...
_itemInfo = switch (_type) do
{
	...
	case "cokep": {["coke","cokep",1500,"Making Cocaine"]};
	...
	case "lsd": {["frogs","lsd",1350,"Cooking Frogs"]};
	case "froglegs": {["frogs","froglegs",1350,"Grilling Frogs"]};
	case "ecstasy": {["mdma","ecstasy",1350,"Making ecstasy"]};
	case "cook": {["chicken","friedchicken",1050,"Cooking"]};
	case "cook": {["meat","steak",1050,"Cooking"]};
	case "cook": {["egg","scramegg",1050,"Cooking"]};
	default {[]};
};
