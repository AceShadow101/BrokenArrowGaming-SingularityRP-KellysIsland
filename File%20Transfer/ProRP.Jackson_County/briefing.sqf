	...
	player createDiaryRecord ["controls",
		[
			"",
				...
				U: Lock and unlock doors<br/>
				T: Vehicle Trunk<br/>
				E (in vehicle): Open gates (Cop/Medic Only)<br/>
				8 (in vehicle as driver): Activate nos (Requires nos item)<br>
				Left Shift + R: Restrain (Cop Only)<br/>
				Left Shift + O: Ziptie (Civ Only)<br/>
				Left Shift + G (not moving): Knock out / stun<br/>
				Left Shift + G (while moving): Crash tackle<br/>
				Left Shift + H: Holster your weapon<br/>
				Left Shift + 7: Surrender<br/>
				Left Shift + P: Lower/Raise sound<br/>
