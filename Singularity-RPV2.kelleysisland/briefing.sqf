...
*/
	player createDiaryRecord["changelog",
		[
			"Official Change Log",
				"
					The official change log can be found on the Ascension-LifeRP.com Forums
				"
		]
	];
	...
	player createDiaryRecord["safezones",
		[
			"Safe Zones",
				"
					If robbing, or killing occurs around these or in these areas it is punishable by ban.<br/><br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Cop Interaction", 
				...
				4. Following and or harassing cops for long periods of time will be considered griefing and/or spamming, and will result in staff action.<br/>
	...
	player createDiaryRecord ["serverrules",
		[
			"Communication Rules", 
				...
				1. Side Chat may not be used except for business advertisement.<br/>
				2. Spamming any chat channel will result in your removal.<br/>
				4. Teamspeak has a TaskForceRadio channel that you must be in with your plug-in enabled if you are in game.<br/><br/>
				"
		]
	];
...
// Police Section
	player createDiaryRecord ["policerules",
		[
			"Crisis Negotiation",
				"
				Crisis Negotiation must be handled by a Member of Swat or Sergeant+. If one is not available, the person with the next highest rank must handle the situation.<br/><br/>
				"
		]
	];
	player createDiaryRecord ["policerules",
	...
	player createDiaryRecord ["policerules",
		[
			"Aviation",
				...
				3. Police may temporarily forbid landing at a location but it cannot remain closed for a long period of time.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Speeding", 
				"
				The following speeds are to be enforced by the Police Force for the absolute safety of the citizens of Kelley's Island and all travelling beyond the city.<br/><br/>
	...
	player createDiaryRecord ["policerules",
		[
			"City Protocol", 
				"
				1. Officers may patrol major cities - Union, Slum, etc. <br/>
				...
				5. Martial law may not be declared unless authorized by command.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Weapons", 
				...
				1. Pistols purchased from the Handgun vendor.<br/><br/>

				Any other weapon (Including Automatice or burst fire pistols) is illegal.<br/><br/>

				1. Civilians are not allowed to have a weapon out within the town limits.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Raiding/Camping",
				"
				Raiding is defined as a squad of police officers invading an area of high criminal activity in order to stop the criminals in illegal acts. To Be Auuthorized By Command!<br/><br/>

				1. In order to raid an area, the cops must have at least 4 officers involved, one of which must be a SWAT Sergeant or above.<br/>
				...
				2. See Bank Robbery and Federal Reserve sections for more info on camping in the main town.<br/>
	...
	player createDiaryRecord ["policerules",
		[
			"Use of Lethal Force",
				...
				2. Discharging of a weapon when not under threat or not during training exercises is not allowed. Officers caught in violation of this rule will be removed from the server and suspended from the PD.<br/>
				3. Failure to follow proper weapons discipline and procedure will get you removed from the server and suspended from the PD.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["policerules",
		[
			"Teamspeak Rule",
				"
				1. All cops must be on Teamspeak 3 in TaskForceRadio with plug-ins enabled. Failure to be on Teamspeak during an admin check will result in your immediate dismissal from the server.<br/><br/>
				"
		]
	];
	...
	player createDiaryRecord ["illegalitems",
		[
			"Rebel Rules",
				...
				1. A rebel must first form a gang (Max 5), and then declare intentions.<br/>
	...
	player createDiaryRecord ["illegalitems",
		[
			"Illegal Vehicles",
				...
				1. Any Vehicle Sold at Black Market<br/>
				"
		]
	];
	player createDiaryRecord ["illegalitems",
		[
			"Illegal Weapons",
				...
				1. Any non-hunting rifle<br/>
				2. Cop Weapons<br/>
				3. Silenced Weapons<br/>
				4. Automatic Pistols<br/>
				5. Burst-fire Pistols<br/>
				6. Any Explosive Device<br/><br/>
				"
		]
	];
	player createDiaryRecord ["illegalitems",
