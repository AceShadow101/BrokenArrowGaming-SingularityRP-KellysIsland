...
class Life_Settings {
	...
	allowedSavedVirtualItems[] = { "pickaxe", "bandages", "fuelEmpty", "fuelFull", "spikeStrip", "lockpick", "defuseKit", "storageSmall", "storageBig", "redgull", "coffee", "donuts", "waterBottle", "apple", "peach", "tbacon", "rabbitGrilled", "salemaGrilled", "ornateGrilled", "mackerelGrilled", "tunaGrilled", "mulletGrilled", "catsharkGrilled", "turtleSoup", "henGrilled", "roosterGrilled", "sheepGrilled", "goatGrilled" };
};
...
class VirtualItems {
	...
	VITEMMACRO(spikeStrip, "STR_Item_SpikeStrip", "spikeStrip", 0, 2500, 1200, false, -1, "")
	...
	VITEMMACRO(blastingcharge, "STR_Item_BCharge", "blastingCharge", 15, 65000, -1, true, -1, "icons\ico_blastingCharge.paa")
	VITEMMACRO(boltcutter, "STR_Item_BCutter", "boltCutter", 5, 55500, -1, true, -1, "icons\ico_boltcutters.paa")
	...
	VITEMMACRO(kidney, "STR_Item_Kidney", "kidney", 15, -1, 10000, false, -1, "")
	VITEMMACRO(bandages, "STR_Item_Bandages", "bandages", 15, 100, 15, false, -1, "")
	...
	VITEMMACRO(oil_processed, "STR_Item_OilP", "oilProcessed", 6, -1, 5000, false, -1, "")
	...
	VITEMMACRO(cottonu, "STR_Item_CottonU", "cottonu", 1, -1, 95, false, -1, "")
	VITEMMACRO(cottonp, "STR_Item_CottonP", "cottonp", 1, -1, 150, false, -1, "")
	VITEMMACRO(woodu, "STR_Item_WoodU", "woodu", 3, -1, 150, false, -1, "")
	VITEMMACRO(woodp, "STR_Item_WoodP", "woodp", 2, -1, 950, false, -1, "")

	//Drugs
	VITEMMACRO(heroin_unprocessed, "STR_Item_HeroinU", "heroinUnprocessed", 6, -1, -1, true, -1, "")
	VITEMMACRO(heroin_processed, "STR_Item_HeroinP", "heroinProcessed", 4, -1, 4000, true, -1, "")
	...
	VITEMMACRO(cocaine_unprocessed, "STR_Item_CocaineU", "cocaineUnprocessed", 6, -1, 2000, true, -1, "")
	VITEMMACRO(cocaine_processed, "STR_Item_CocaineP", "cocaineProcessed", 4, -1, 3000, true, -1, "")

	//Drink
	VITEMMACRO(redgull, "STR_Item_RedGull", "redgull", 1, 500, 200, false, 100, "icons\ico_redgull.paa")
	...
	VITEMMACRO(bottledshine, "STR_Item_BottledShine","bottledshine",2,500,300,true,-1,"")
	VITEMMACRO(bottledwhiskey, "STR_Item_BottledWhiskey","bottledwhiskey",2,400,200,false,-1,"")
	VITEMMACRO(bottledbeer, "STR_Item_BottledBeer","bottledbeer",2,300,100,false,-1,"")
	VITEMMACRO(moonshine, "STR_Item_Moonshine","moonshine",2,-1,1000,true,-1,"")
	VITEMMACRO(whiskey, "STR_Item_Whiskey","whiskey",2,-1,500,false,-1,"")
	VITEMMACRO(beerp, "STR_Item_Beerp","beerp",2,-1,500,false,-1,"")
	...
	VITEMMACRO(glassbottle, "STR_Item_Bottles","glassbottle",1,1000,-1,false,-1,"")
	...
	VITEMMACRO(turtle_raw, "STR_Item_TurtleMeat", "turtleRaw", 6, 5000, 4000, true, -1, "icons\food.paa")
...
class Licenses {
	...
	LICENSEMACRO(cotton,"STR_License_Cotton","cotton",2500,false,"civ")
	LICENSEMACRO(wood,"STR_License_Wood","wood",2500,false,"civ")
	LICENSEMACRO(mAir,"STR_License_Pilot","mAir",15000,false,"med")
	LICENSEMACRO(home,"STR_License_Home","home",75000,false,"civ")
	LICENSEMACRO(donator,"STR_License_Donator","donator",0,false,"civ")
	LICENSEMACRO(stiller,"STR_License_Stiller","stiller",50000,false,"civ")
	LICENSEMACRO(liquor,"STR_License_Liquor","liquor",17000,false,"civ")
	LICENSEMACRO(bottler,"STR_License_Bottler","bottler",20000,false,"civ")
	LICENSEMACRO(mash,"STR_License_Mash","mash",2000,false,"civ")
	LICENSEMACRO(service,"STR_License_Service","service",-1,false,"civ")
};

class VirtualShops {
	class market {
		name = "STR_Shops_Market";
		items[] = { "waterBottle", "cornmeal",  "goat_raw", "rooster_raw", "donuts", "sheep_raw",  "hen_raw", "rabbit_raw",  "apple", "cottonp", "woodp", "redgull", "tbacon", "lockpick", "pickaxe", "fuelFull", "peach", "boltcutter", "storagesmall", "storagebig" };
	};
	
	class medicmarket {
		name = "STR_Shops_MedicMarket";
		items[] = { "waterBottle", "apple", "redgull", "lockpick", "tbacon", "fuelFull", "peach", "bandages" };
	};
	
	class bar {
		name = "STR_Shops_Bar";
		items[] = { "bottledshine", "bottledwhiskey", "bottledbeer" };
	};

	class rebel {
		name = "STR_Shops_Rebel";
		items[] = { "waterBottle", "rabbit_grilled", "apple", "redgull", "tbacon", "lockpick", "pickaxe", "fuelFull", "peach", "boltcutter", "blastingcharge", "kidney" };
	};
