...
if(_curTarget isKindOf "House_F" && {player distance _curTarget < 12} OR ((nearestObject [[5640.431152,4073.159668,0],"Land_MilOffices_V1_F"]) == _curTarget OR (nearestObject [[5640.431152,4073.159668,0],"Land_Research_house_V1_F"]) == _curTarget)) exitWith {
