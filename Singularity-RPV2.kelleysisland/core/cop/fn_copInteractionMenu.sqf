...
if(_curTarget isKindOf "House_F") exitWith {
	if((nearestObject [[5640.431152,4073.159668,0],"Land_MilOffices_V1_F"]) == _curTarget OR (nearestObject [[5640.431152,4073.159668,0],"Land_Research_house_V1_F"]) == _curTarget) then {
...
if(!((player distance (getMarkerPos "cop_spawn_2") < 200) OR (player distance (getMarkerPos "cop_spawn_1") < 30))) then  {
