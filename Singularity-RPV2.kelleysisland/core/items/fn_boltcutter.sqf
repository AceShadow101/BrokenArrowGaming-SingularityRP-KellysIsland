...
if((nearestObject [[5640.431152,4073.159668,0],"Land_milOffices_v1_F"]) == _building OR (nearestObject [[5640.431152,4073.159668,0],"Land_Research_house_V1_F"]) == _building) then {
