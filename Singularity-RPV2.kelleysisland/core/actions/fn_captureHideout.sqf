...
/*
	...
	Blah blah.
*/
private["_group","_hideout","_action","_cpRate","_cP","_progressBar","_title","_titleText","_ui","_flagTexture","_markername","_gangname"];
_hideout = (nearestObjects[getPosATL player,["Land_Slum_House03_F"],25]) select 0;
