...
_itemInfo = switch (_type) do {
	...
	case "moonshine": {["yeast","moonshine",7500,(localize "STR_Process_Moonshine")];};
	case "bottledshine": {["moonshine","bottledshine",5000,(localize "STR_Process_BottledShine")];};
	case "bottledbeer": {["beerp","bottledbeer",5000,(localize "STR_Process_BottledBeer")];};
	case "bottledwhiskey": {["whiskey","bottledwhiskey",5000,(localize "STR_Process_BottleWhiskey")];};
	case "glassbottle": {["glass","glassbottle",2500,(localize "STR_Process_Bottles")];};
	case "wood": {["woodu","woodp",2500,(localize "STR_Process_Wood")];};
	case "cotton": {["cottonu","cottonp",2500,(localize "STR_Process_Cotton")];};
	default {[];};
};
