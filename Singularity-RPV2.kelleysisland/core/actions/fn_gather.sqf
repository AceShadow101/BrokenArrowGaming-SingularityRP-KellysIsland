...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","heroin_1","cocaine_1","weed_1","rye_1","hops_1","yeast_1","wood_1","cotton_1"];
_zone = "";
...
switch(true) do {
	...
	case (_zone in ["wood_1"]): {_gather = ["woodu",2];}; 
	case (_zone in ["cotton_1"]): {_gather = ["cottonu",2];}; 
	default {""};
};
//gather check??
