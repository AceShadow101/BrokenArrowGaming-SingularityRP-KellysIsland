...
switch (_var) do
{
	...
	case "life_inv_salema": {(localize "STR_Item_Salema")};
	...
	case "life_inv_cottonu": {(localize "STR_Item_CottonU")};
	case "life_inv_cottonp": {(localize "STR_Item_CottonP")};
	...
	case "license_civ_cotton": {(localize "STR_License_Cotton")};
